                        ...
                        <div class="row g-4 fruite">
                            ...
                            <div class="col-lg-12">
                                <div class="position-relative">
                                    <img src="assets/img/brandnew-img6.jpg" class="img-fluid w-100 rounded" alt="">
                                    <div class="position-absolute" style="top: 20%; right: 10px; transform: translateY(-50%);">
                                        <h3 class="text-secondary fw-bold">New <br> Products <br> Banner</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
