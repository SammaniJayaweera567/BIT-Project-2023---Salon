                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        ...
                        <div class="d-flex m-3 me-0">
                            <ul class="d-inline-flex list-unstyled menu-rigth mb-0">
                                ...
                                // Check if all State values are 0
                                $state_check_sql = "SELECT COUNT(*) AS count FROM users WHERE State <> 0";
                                $result = $db->query($state_check_sql);
                                $row = $result->fetch_assoc();

                                if ($row['count'] == 0) {
                                    // All State values are 0
                                    ?>
                                    <li><a class="btn btn-primary me-4 py-2 rounded-pill" href="register.php">Register</a></li>
                                    <li><a class="btn btn-primary me-4 py-2 rounded-pill" href="login.php">Login</a></li>
                                    <?php
                                } else {
                                    // Not all State values are 0
                                    ?>
                                    <li><a href="register.php"><button type="button" class="btn btn-primary me-4 py-2 rounded-pill">Welcome, <?= $_SESSION['FIRSTNAME'] ?></button></a></li>
                                    <li><a href="logout.php"><button type="button" class="btn btn-primary me-4 py-2 rounded-pill">Logout</button></a></li>
                                    <?php
                                }
                                ?>
                            </ul>
