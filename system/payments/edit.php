...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($message)) {
        $db = dbConn();
        $sql = "UPDATE payments SET invoice_id='$invoice_id', payment_date='$payment_date', payment_amount='$payment_amount', payment_method='$payment_method', payment_type='$payment_type', transaction_id='$transaction_id' WHERE payment_id='$payment_id'";
        $db->query($sql);
...
<div class="row">
    <div class="col-12">
        <a href="<?= SYS_URL ?>payments/manage.php" class="btn btn-dark mb-3"><i class="fas fa-arrow-left"></i> Back to Manage</a>
