...
<html lang="en">
    ...
    <body class="hold-transition login-page login-page-bg" style="background-image: url('assets/dist/img/systemlogin-bg.jpg')">
        <div class="login-box">
            <div class="login-logo">
                <a href="../../index2.html" class="text-white"><b>Salon</b> Angel</a>
            </div>
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if (empty($message)) {
                    ...
                    if ($result->num_rows == 1) {
                        ...
                        $message['password'] = "Invalid User Name...!";
                    }
                }
            }
            ?>
                ...
                <div class="card-body login-card-body">
                    ...
                    <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <!-- /.col -->
                            <div class="col-4">
                                <button type="submit" class="btn btn-block primary-bg-color text-white py-2 px-4 rounded-pill">Sign In</button>
                            </div>
                            <!-- /.col -->
                        </div>
                    </form>

                    <!-- Validation of username and password in login form -->
